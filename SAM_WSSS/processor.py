...
class Processor:
    def __init__(self, params, num_cls=21):
        ...
        self.save_path = f'{self.pseudo_path}_processed'
    ...
    def generate_samples(self):
        ...
        if selected_files is None or len(selected_files) == 0:
            ...
            for f in selected_files:
                ...
                image_row.append(os.path.join(self.image_path, '%s.png' % name))
                image_row.append(f)
            ...
            for f in selected_files:
                image_row = []
                image_row.append(os.path.join(self.image_path, '%s.png' % f))
