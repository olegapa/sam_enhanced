...
class_names_custom = ['cape, jacket, coat, cardigan', 'blouse, shirt', 'hoodie, jumper, sweater, sweatshirt',
                      'Dress, Romper', 'jeans, leggings, pants, tights', 'shorts', 'skirt', 'Shoes', 'Vest',
                      'Boots', 'bodysuit, t-shirt, top', 'bag, purse', 'hat', 'tie, scarf', 'gloves',
                      'blazer, suit', 'intimate, panties, swimwear, bra', 'socks, stockings'
                      ]

BACKGROUND_CATEGORY_CUSTOM = ['accessories', 'belt', 'glasses', 'sunglasses', 'bracelet', 'earrings', 'hair',
                              'skin', 'necklace', 'ring', 'wallet', 'watch', 'ground', 'wall']
