...
def crf(n_jobs, is_coco=False):
    ...
    def process(i):
        ...
        image_path = os.path.join(args.image_root, image_id + '.png')
...
if __name__ == "__main__":
    ...
    parser.add_argument("--cam_out_dir", default="E:\\Masters_dipl\\clothes_classification\\code\\output\\clipes\\cams_filtered", type=str)
    parser.add_argument("--pseudo_mask_save_path", default="E:\\Masters_dipl\\clothes_classification\\code\\output\\clipes\\pseudo_2", type=str)
    parser.add_argument("--split_file", default="E:\\Masters_dipl\\clothes_classification\\code\\CLIP-ES\\custom_dataset\\train.txt",
                        type=str)
    ...
    parser.add_argument("--image_root", default="E:\\Masters_dipl\\clothes_classification\\datasets\\Fashionpedia_resized\\train", type=str)
